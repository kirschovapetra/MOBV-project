...
abstract class BalanceDao : EntityDao<Balances>() {
    ...
    @Query("SELECT * FROM balances WHERE asset_code = :assetCode and source_account = :sourceAccount LIMIT 1")
    abstract fun getByAssetCodeAndSourceAccount(assetCode: String, sourceAccount: String): LiveData<Balances>
